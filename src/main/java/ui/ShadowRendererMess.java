...
class ShadowRendererMess {
    ...
    public ShadowRendererMess() {
        this(5, 0.5f, Color.BLACK);
    }

    public ShadowRendererMess(final int size, final float opacity, final Color color) {
        this.size = size;
    ...
    public BufferedImage createShadow(final BufferedImage image) {
        ...
        GraphicsUtilitiesMess.getPixels(image, 0, 0, srcWidth, srcHeight, srcBuffer);
        ...
        GraphicsUtilitiesMess.setPixels(dst, 0, 0, dstWidth, dstHeight, dstBuffer);
        return dst;
    }
}

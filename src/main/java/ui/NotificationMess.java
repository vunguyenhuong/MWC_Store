...
public class NotificationMess extends javax.swing.JComponent {
    ...
    public NotificationMess(Frame fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/icons/sucess.png")));
    ...
    private BufferedImage createShadow() {
        ...
        g2.dispose();
        return new ShadowRendererMess(shadowSize, 0.3f, new Color(100, 100, 100)).createShadow(img);
    }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/sucess.png"))); // NOI18N
        ...
        cmdClose.setFont(new java.awt.Font("Segoe UI Semibold", 0, 22)); // NOI18N
        cmdClose.setText("X");

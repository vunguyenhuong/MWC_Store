...
public class ExportChatLieu {
    ...
    public static void writeExcel(List<ChatLieu> list, String excelFilePath) throws IOException {
    ...
    private static void writeBook(ChatLieu d, Row row) {

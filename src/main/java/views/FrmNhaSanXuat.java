...
import utilities.ExportNSX;
import utilities.Helper;
import utilities.ImportNSX;
...
public class FrmNhaSanXuat extends javax.swing.JPanel {
    ...
    public void pagination(String ten) {
        ...
        if (pg.getTotalPage() < pg.getCurrent()) {
            ...
            loadToTable(iNhaSXService.pagination(pg.getTotalPage(), limit, ten));
        } else {
            pagination1.setPagegination(pg.getCurrent(), pg.getTotalPage());
            loadToTable(iNhaSXService.pagination(pg.getCurrent(), limit, ten));
        }
        clear();
        pagination1.addEventPagination(new EventPagination() {
            @Override
            public void pageChanged(int page) {
                loadToTable(iNhaSXService.pagination(page, limit, ten));
                pg.setCurrent(page);
            }
        });
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(rd_Ngungnhap, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(rd_Dangnhap, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tableScrollButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 521, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                if (helper.confirm(this, "File Path: " + fileToSave.getAbsolutePath() + filter.getDescription() + ". Xác nhận xuất file ?")) {
                    ExportNSX.writeExcel(iNhaSXService.getAll(), fileToSave.getAbsolutePath() + filter.getDescription());
    ...
    private void btn_importExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_importExcelActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                List<NhaSX> list = ImportNSX.readExcel(fileOpen.getAbsolutePath());

                if (helper.confirm(this, "Xác nhận thêm " + list.size() + " nhà sản xuất ?")) {
                    for (NhaSX x : list) {
                        NhaSX d = iNhaSXService.getObj(x.getMa());
                        if (d != null) {

                            continue;
                        } else {
                            iNhaSXService.save(x);
                        }

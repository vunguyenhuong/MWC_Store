 ...
 */
public class ChartDoanhThu1 extends javax.swing.JFrame {

    private static IHoaDonService iHoaDonService = new HoaDonService();
    private boolean gained = false;

    public ChartDoanhThu1(int nam) {
        initComponents();
        ...
        try {
            for (int i = 1; i <= 12; i++) {
                chart1.addData(new ModelChart("Tháng " + i, new double[]{iHoaDonService.doanhThuTheoThang(i, nam).doubleValue()}));
            }
        } catch (Exception e) {
        }
        chart1.start();

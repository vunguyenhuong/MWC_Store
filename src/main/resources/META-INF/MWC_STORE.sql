...
GO
INSERT KHACHHANG (Ma, Ten, Sdt, DiaChi, DiemTichLuy, TongDiemTichLuy) VALUES (N'KH2', N'Phạm Tiến Đạt', N'0333222444', N'Hà Nội', 0,0)
GO
INSERT KHACHHANG (Ma, Ten, Sdt, DiaChi, DiemTichLuy, TongDiemTichLuy) VALUES (N'KH3', N'Phạm Đức Anh', N'0888666444', N'Hải Dương', 0,0)
...
SELECT * FROM CHITIETDEP WHERE IDDEP = 5 AND IdLoaiDep = 4
AND IdMauSac = 4 AND IdChatLieu = 3 AND IdNsx = 1 AND IdSize = 3


SELECT COUNT(IDCTD) FROM HOADONCHITIET WHERE IDCTD = 6

delete from NGUOIDUNG where ma = '026203001126'

SELECT * FROM HOADONCHITIET A JOIN HOADON B ON A.IdHD = B.ID WHERE B.NgayThanhToan LIKE '2022-11-22%'
